...
public class UWService {
	...
	public BikeOutput getBikeDetails(UWInput input)
	{
		...
		BreOutputDetails breoutput =getBreDetails(breinput);
		...
		BikeOutput bikeoutput =getBikeopediaDetails(bikeinput);
	...
	public BreOutputDetails getBreDetails(BreInputDetails input)
	{
		...
		//rest call
			...
			ResponseEntity<BreOutputDetails> entity= restTemplate.exchange("http://bre-service/mca/bre", HttpMethod.POST,httpentity, BreOutputDetails.class);
		//ResponseEntity<?> entity=  restTemplate.getForEntity("http://BRE-SERVICE/mca/bre", BreOutputDetails.class, input);
